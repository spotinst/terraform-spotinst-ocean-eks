...
| <a name="input_root_volume_size"></a> [root\_volume\_size](#input\_root\_volume\_size) | The size of the root volume to use for worker node instances | `number` | `20` | no |
